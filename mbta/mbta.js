...
function init() {
    var map = new.google.maps.Map(document.getElementById('mbta_canvas'), {
...
var map = new google.maps.Map(document.getElementById("mbta_canvas"),mapProp;

var image = 'cheshire_cat.png';
...
function setMarkersredLine(map) {
    for(var i =0; i<redLineAlewifeToJFK.length; i++){
        ...
        var marker = new.google.maps.Marker({
            position: {lat: redLineAlewifeToJFK[1], lng: redLineAleWifeToJFK[2]},
            map: map,
            icon: image,
            title: redLineAlewifetoJFK[0], 
            zIndex: redLinfeAlewifetoJFK[3]
        }
    }
